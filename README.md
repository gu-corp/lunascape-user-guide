# Lunascape User Guide

Lunascape 製品群のユーザーマニュアルを 1 つのリポジトリで管理します。
製品ごとのディレクトリが、それぞれ独立した文書ルートです（[Lunascape Docs](https://docs.lunascape.org/) で配信されます）。
...
- 各文書ルートは自分の `lunascape-docs.json`・言語構成・INDEX を持ちます。翻訳は各フォルダー横の `i18n/<locale>/` に置きます。
